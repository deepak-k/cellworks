...
myfile = open('final_record.csv', 'w')
writer = csv.writer(myfile, delimiter=',')


oncoMap = dict();
MapOncokb(oncoMap)
with open('oncoKB_tmp.csv', 'r') as csvFd:
...
civicMap = dict()
MapCivic(civicMap)
with open('civic_tmp.csv', 'r') as csvFd:
    reader = csv.reader(csvFd, delimiter='\t')
    for row in reader:
...
with open('synapse_tmp.csv', 'r') as csvFd:
    reader = csv.reader(csvFd, delimiter=',')
    for row in reader:
...
docmMap = dict()
MapDocm(docmMap)
with open('docm_tmp.tsv', 'r') as csvFd:
    reader = csv.reader(csvFd, delimiter='\t')
    for row in reader:
...
candlMap = dict()
MapCandl(candlMap)
with open('candl_tmp.csv', 'r') as csvFd:
    reader = csv.reader(csvFd, delimiter=',')
    for row in reader:
...
db_conn = MySQLdb.connect(host='localhost', user='root', passwd='root')
cur = db_conn.cursor()
